...
namespace UHub.CoreLib.Entities.Posts.DataInterop
{
    ...
    public static partial class PostReader
    {
        ...
        public static Post TryGetPost(long PostID)
        {
            ...
            {
                CoreFactory.Singleton.Logging.CreateErrorLog(ex, "CCE3A0A5-DC88-42B6-ADC0-F2F95995203C");
                return null;
            }
        }
        ...
        public static IEnumerable<Post> TryGetAllPosts()
        {
            ...
            {
                CoreFactory.Singleton.Logging.CreateErrorLog(ex, "00877A2B-2DE3-492A-9EFE-5FDB837E9C59");
        ...
        public static IEnumerable<PostClusteredCount> TryGetPostClusteredCounts()
        {
            ...
            {
                CoreFactory.Singleton.Logging.CreateErrorLog(ex, "D93AA28B-A453-4BC1-B32C-882BEAEDCEDE");
                return null;
            }
        }
