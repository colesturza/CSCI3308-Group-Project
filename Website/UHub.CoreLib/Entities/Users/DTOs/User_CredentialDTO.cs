...
namespace UHub.CoreLib.Entities.Users.DTOs
{
    ...
    public sealed partial class User_CredentialDTO : DtoEntityBase, IUserCredential
    {
        ...
        [RegularExpression(RgxPtrn.User.EMAIL_B, ErrorMessage = "Email address is not valid")]
        ...
        [RegularExpression(RgxPtrn.User.PASSWORD_B, ErrorMessage = "Password must be between 8 and 150 characters")]
