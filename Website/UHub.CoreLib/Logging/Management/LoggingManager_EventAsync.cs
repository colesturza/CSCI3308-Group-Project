...
namespace UHub.CoreLib.Logging.Management
{
    ...
    public sealed partial class LoggingManager
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="data"></param>
        public async Task CreateEventLogAsync<T>(string UID, T Data, EventType EventType)
        {
            var eventData = new EventLogData
            {
                EventType = EventType,
        ...
        /// </summary>
        /// <param name="message"></param>
        public async Task CreateEventLogAsync(string UID, string Message, EventType EventType)
        {
            var eventData = new EventLogData
            {
                EventType = EventType,
