...
namespace UHub.CoreLib.Users
{
    ...
    [DataClass]
    public partial class User : DBEntityBase, IUser_Internal, IUser_Create_Internal, IUser_Update_Private
    {
        ...
        {
            if (this.UserID == null || this.RefUID.IsEmpty())
            {
                return "/";
            }
        ...
        {
            return UserReader.GetUserRecoveryContext(this.UserID.Value);
        }
        ...
        public void UpdateVersion()
        {
            ...
            UserWriter.UpdateUserVersion(this.UserID.Value, version);
