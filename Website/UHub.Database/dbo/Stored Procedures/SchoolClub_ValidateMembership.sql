create proc dbo.SchoolClub_ValidateMembership
	@ClubID bigint,
	@UserID bigint
...
begin
	...
	if(exists(select * from dbo.EntMemberXRef where TargetEntID = @ClubID AND ActorEntID = @UserID AND IsApproved = 1 AND IsBanned = 0))
	begin
