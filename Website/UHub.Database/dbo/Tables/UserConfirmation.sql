CREATE TABLE [dbo].[UserConfirmation] (
    ...
    [ConfirmedDate] DATETIMEOFFSET (7) CONSTRAINT [DF_UserConfirmation_ConfimedDate] DEFAULT (NULL) NULL,
    [IsConfirmed]   BIT                CONSTRAINT [DF_UserConfirmation_IsConfirmed] DEFAULT ((0)) NOT NULL,
